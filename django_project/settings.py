...
LOGIN_URL = "login"  # this redirect the page that user trying to access before the log in, if we don't assign
# this, page going to be redirected to the default redirect option (for instance; /blog/home/)
